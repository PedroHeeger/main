...
- [Introdução e Laboratório Virtual](../cert_ti/04-curso/os/linux/(23-07-31)%20Docker-Utilização...Cenário%20de%20Microsserviços%20PH%20DIO.pdf) {Plataforma: **DIO**; Carga Horária: **1 Hora**; Concluído em: **17/08/23**; [Pasta do Projeto](https://github.com/PedroHeeger/boot/tree/main/dio/docker/boot_006/01-introducao_docker#item1.1)}
- [Armazenamento de Dados com Docker](../cert_ti/04-curso/os/linux/(23-07-31)%20Docker-Utilização...Cenário%20de%20Microsserviços%20PH%20DIO.pdf) {Plataforma: **DIO**; Carga Horária: **1 Hora**; Concluído em: **18/08/23**; [Pasta do Projeto](https://github.com/PedroHeeger/boot/tree/main/dio/docker/boot_006/01-introducao_docker#item1.3)}
- [Primeiros Passos com o Docker](../cert_ti/04-curso/os/linux/(23-07-31)%20Docker-Utilização...Cenário%20de%20Microsserviços%20PH%20DIO.pdf) {Plataforma: **DIO**; Carga Horária: **1 Hora**; Concluído em: **18/08/23**; [Pasta do Projeto](https://github.com/PedroHeeger/boot/tree/main/dio/docker/boot_006/01-introducao_docker#item1.2)}
- [Definição e Criação de um Docker File](../cert_ti/04-curso/os/linux/(23-07-31)%20Docker-Utilização...Cenário%20de%20Microsserviços%20PH%20DIO.pdf) {Plataforma: **DIO**; Carga Horária: **1 Hora**; Concluído em: **19/08/23**; [Pasta do Projeto](https://github.com/PedroHeeger/boot/tree/main/dio/docker/boot_006/02-dockerfile_compose#item2.1)}
- [Processamento, Logs e Rede com Docker](../cert_ti/04-curso/os/linux/(23-07-31)%20Docker-Utilização...Cenário%20de%20Microsserviços%20PH%20DIO.pdf) {Plataforma: **DIO**; Carga Horária: **1 Hora**; Concluído em: **19/08/23**; [Pasta do Projeto](https://github.com/PedroHeeger/boot/tree/main/dio/docker/boot_006/01-introducao_docker#item1.4)}
- [Criando um Container de uma Aplicação WEB](../cert_ti/04-curso/os/linux/(23-07-31)%20Docker-Utilização...Cenário%20de%20Microsserviços%20PH%20DIO.pdf) {Plataforma: **DIO**; Carga Horária: **1 Hora**; Concluído em: **21/08/23**; [Pasta do Projeto](https://github.com/PedroHeeger/boot/tree/main/dio/docker/boot_006/02-dockerfile_compose#item2.3)}
- [Docker Compose](../cert_ti/04-curso/os/linux/(23-07-31)%20Docker-Utilização...Cenário%20de%20Microsserviços%20PH%20DIO.pdf) {Plataforma: **DIO**; Carga Horária: **1 Hora**; Concluído em: **21/08/23**; [Pasta do Projeto](https://github.com/PedroHeeger/boot/tree/main/dio/docker/boot_006/02-dockerfile_compose#item2.2)}
- [Load Balancer](../cert_ti/04-curso/os/linux/(23-07-31)%20Docker-Utilização...Cenário%20de%20Microsserviços%20PH%20DIO.pdf) {Plataforma: **DIO**; Carga Horária: **1 Hora**; Concluído em: **21/08/23**; [Pasta do Projeto](https://github.com/PedroHeeger/boot/tree/main/dio/docker/boot_006/03-docker_swarm#item3.2)}
- [Criando um Cluster com o Docker Swarm](../cert_ti/04-curso/os/linux/(23-07-31)%20Docker-Utilização...Cenário%20de%20Microsserviços%20PH%20DIO.pdf) {Plataforma: **DIO**; Carga Horária: **2 Horas**; Concluído em: **22/08/23**; [Pasta do Projeto](https://github.com/PedroHeeger/boot/tree/main/dio/docker/boot_006/03-docker_swarm#item3.1)}
- [Definição de um Cluster Swarm Local com o Vagrant](../cert_ti/04-curso/os/linux/(23-07-31)%20Docker-Utilização...Cenário%20de%20Microsserviços%20PH%20DIO.pdf) {Plataforma: **DIO**; Carga Horária: **1 Hora**; Concluído em: **22/08/23**; [Pasta do Projeto](https://github.com/PedroHeeger/boot/tree/main/dio/docker/boot_006/03-docker_swarm#item3.3)}
...
- [Simplifica Power BI Express](../cert_ti/05-particip/data/power_bi/) {Plataforma: **Simplifica Treinamentos**; Carga Horária: **10 Horas**; Concluído em: **10/08/23**; [Pasta do Projeto](https://github.com/PedroHeeger/course/tree/main/simplifica_trein/power_bi/curso_075)}
